...
namespace Microsoft.PowerShell.Commands
{
        ...
        ISecurityDescriptorCmdletProvider
    {
        ...
        {
	    //Console.WriteLine("xxx ps00-2400-0: NewDrive is drive null? " + (drive == null ? "yes" : "no"));
            //try
            //{
		//Console.WriteLine("xxx ps00-2400-2: " + drive.Root);
		//Console.WriteLine("xxx ps00-2400-4: pwd " + System.IO.Directory.GetCurrentDirectory());
		//Console.WriteLine("xxx ps00-2400-6: driveInfo " + System.IO.Path.GetPathRoot(drive.Root));
                //var driveInfo = new System.IO.DriveInfo(System.IO.Path.GetPathRoot(drive.Root));
                //var driveInfo = new System.IO.DriveInfo("/");
		//Console.WriteLine("xxx ps00-2402-0: driveInfo2");
