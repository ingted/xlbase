...
dpkg -i  grub-pc_2.02~beta2-9ubuntu1.3_amd64.deb grub-common_2.02~beta2-9ubuntu1.3_amd64.deb grub2-common_2.02~beta2-9ubuntu1.3_amd64.deb grub-pc-bin_2.02~beta2-9ubuntu1.3_amd64.deb grub-gfxpayload-lists_0.6_amd64.deb libaudit1_2.4.4-4ubuntu1_amd64.deb libauparse0_2.4.4-4ubuntu1_amd64.deb libaudit-common_2.4.4-4ubuntu1_all.deb libselinux1_2.3-2_amd64.deb libselinux1-dev_2.3-2_amd64.deb libsepol1-dev_2.3-2_amd64.deb libsepol1_2.3-2_amd64.deb python-ipy_0.83-1_all.deb   selinux-utils_2.3-2build1_amd64.deb python-audit_2.4.4-4ubuntu1_amd64.deb    python-selinux_2.3-2_amd64.deb python-semanage_2.3-1build1_amd64.deb
apt-get install libapol4 libqpol1 policycoreutils
